...
class Model(nn.Module):
    def __init__(self, inChannel, coverageDepth, classN, window_size, leak_value):
        ...
        self.cell1 = nn.Sequential(
            nn.Conv2d(self.outChannels[0], self.outChannels[1], (1, 3), groups=10,
                      padding=(0, 1), bias=False, stride=(1, 1)),
            nn.BatchNorm2d(self.outChannels[1]),
            nn.ReLU(),
            nn.Conv2d(self.outChannels[1], self.outChannels[1], (1, 5), groups=4,
                      padding=(0, 2), bias=False, stride=(1, 1)),
        )
        ...
        self.cell2 = nn.Sequential(
            ...
            nn.ReLU(),
            nn.Conv2d(self.outChannels[2], self.outChannels[2], (1, 5), groups=8,
                      padding=(0, 2), bias=False, stride=(1, 1)),
        )
        ...
        self.cell3 = nn.Sequential(
            ...
            nn.ReLU(),
            nn.Conv2d(self.outChannels[3], self.outChannels[3], (1, 5), groups=16,
                      padding=(0, 2), bias=False, stride=(1, 1)),
        )
        #
        ...
        #     nn.ReLU(),
        #     nn.Conv2d(self.outChannels[4], self.outChannels[4], (1, 5), groups=32,
        #               padding=(0, 2), bias=False, stride=(1, 1)),
        # )
        #
        ...
        #     nn.ReLU(),
        #     nn.Conv2d(self.outChannels[5], self.outChannels[5], (1, 5), groups=64,
        #               padding=(0, 2), bias=False, stride=(1, 1)),
        # )
