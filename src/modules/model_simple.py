...
class Model(nn.Module):
    def __init__(self, inChannel, coverageDepth, classN, window_size, leak_value):
        ...
        self.cell3 = nn.Sequential(
            ...
            nn.ReLU(),
            nn.Conv2d(self.outChannels[3], self.outChannels[3], (1, 3), groups=16,
                      padding=(0, 1), bias=False, stride=(1, 1)),
        )
        ...
        self.cell4 = nn.Sequential(
            ...
            nn.ReLU(),
            nn.Conv2d(self.outChannels[4], self.outChannels[4], (1, 3), groups=32,
                      padding=(0, 1), bias=False, stride=(1, 1)),
        )
        ...
        self.cell5 = nn.Sequential(
            ...
            nn.ReLU(),
            nn.Conv2d(self.outChannels[5], self.outChannels[5], (1, 3), groups=64,
                      padding=(0, 1), bias=False, stride=(1, 1)),
        )
