...
if __name__ == '__main__':
    ...
    train_dset = PileupDataset(FLAGS.summary_file, transformations)
    test_dset = PileupDataset(FLAGS.summary_file, transformations)
    ...
    print('Total homalt: ', total_homalt, 'Correctly predicted: ', correct_homalt, 'Accuracy: ', correct_homalt/total_homalt * 100)
