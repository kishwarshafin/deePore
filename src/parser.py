...
class pileUpCreator:
    ...
    '''
    def __init__(self, bamFile, fastaFile):
        '''
...
def generatePileup(region, start, end, bamFile, refFile):
    '''
...
def generateImageLinear(dictionary, coverage):
    '''
...
if __name__ == '__main__':
    ...
    sd = generatePileup(FLAGS.region, FLAGS.site_start, FLAGS.site_end, FLAGS.bam, FLAGS.ref)
    #print("--- %s seconds to generate pileup---" % (time.time() - start_time))
    start_time = time.time()
    #generateImage(sd, FLAGS.coverage)
    ...
    #print("--- %s seconds to generate image---" % (time.time() - start_time))
    #'''

    #---TEST---#
    #p = pileUpCreator(FLAGS.bam, FLAGS.ref)
    #dict = p.generatePileupLinear(FLAGS.region, FLAGS.site_start, FLAGS.site_end)
    #generateImageLinear(dict, FLAGS.coverage)